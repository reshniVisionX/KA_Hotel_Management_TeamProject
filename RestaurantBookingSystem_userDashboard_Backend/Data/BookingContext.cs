...
namespace RestaurantBookingSystem.Data
{
    public class BookingContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // DineIn: Cascade delete when Restaurant is deleted
            modelBuilder.Entity<DineIn>()
                .HasOne(d => d.Restaurants)
                .WithMany()
            ...
            // --------------------------------------------------------------------
            // 💡 You can add explicit relationships if EF complains about ambiguity
            // --------------------------------------------------------------------
            ...
            modelBuilder.Entity<ManagerPayment>()
            ...
            modelBuilder.Entity<Notifications>()
               .HasOne<Users>()                 // Related entity type
               .WithMany()                     // No collection on the other side
               .HasForeignKey(n => n.UserId)   // Foreign key property
               .OnDelete(DeleteBehavior.Cascade);

            modelBuilder.Entity<Delivery>()
               .HasOne(d => d.DeliveryAddress)
               .WithMany() // A DeliveryAddress can be linked to many Deliveries (optional)
               .HasForeignKey(d => d.AddressId)
               .OnDelete(DeleteBehavior.Restrict); // Prevents cascade delete if address is removed

            // 🔗 Configure DeliveryPerson relationship
            modelBuilder.Entity<Delivery>()
