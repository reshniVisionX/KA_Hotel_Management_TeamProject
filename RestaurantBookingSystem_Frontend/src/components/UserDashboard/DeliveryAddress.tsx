...
import { getUserAddresses, removeAddress } from '../../Service/dashboard.api';
...
const DeliveryAddress = () => {
  ...
  const handleRemoveAddress = async (addressId: number) => {
    try {
      ...
      // Refresh the addresses after removal
      fetchAddresses();
    } catch (err) {
      const error = err as AppError;
              ...
              <div className="delivery-address-actions">
                {editingProfile ? (
                  ...
                  <button 
                    ...
                    className="delivery-address-remove-btn"
                    style={{ backgroundColor: '#e47b0bff', color: 'white' }}
                  >
                    Edit Profile
                  </button>
                )}
          ...
          {addresses.length === 0 ? (
            ...
            <div className="delivery-address-grid">
              {addresses.map((address: any) => (
                <div key={address.addressId} className="delivery-address-card">
