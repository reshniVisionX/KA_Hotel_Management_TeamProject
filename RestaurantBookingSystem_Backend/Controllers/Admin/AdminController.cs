...
namespace RestaurantBookingSystem.Controllers
{
  ...
  [Authorize]
    public class AdminController : ControllerBase
    {
        ...
        public async Task<ActionResult> UpdateVerification([FromBody] UpdateVerificationRequest request)
        {
            var result = await _adminService.UpdateManagerVerificationAsync(
                request.ManagerId,
