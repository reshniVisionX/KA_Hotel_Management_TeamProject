...
namespace RestaurantBookingSystem.Services
{
    public class AdminServices: IAdminService
    {
        ...
        public Task<IEnumerable<ManagerDetails>> GetAllManagersAsync() =>
            _adminRepo.GetAllManagersAsync();
        ...
        public async Task<bool> UpdateManagerVerificationAsync(int managerId, IsVerified status)
        {
            return await _adminRepo.UpdateVerificationAsync(managerId, status);
        }
    }
}
