...
{
    /// <inheritdoc />
    public partial class Init_Restaurant : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DineIn_Restaurants_RestaurantId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Wishlist_MenuList_ItemId",
                        column: x => x.ItemId,
                        principalTable: "MenuList",
                        principalColumn: "ItemId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Wishlist_Restaurants_RestaurantId",
                        column: x => x.RestaurantId,
                        principalTable: "Restaurants",
                        principalColumn: "RestaurantId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "CreatedAt", "Email", "FirstName", "IsActive", "LastLogin", "LastName", "Mobile", "Password", "RoleId" },
                values: new object[,]
                {
                    { 1, new DateTime(2023, 1, 1, 12, 0, 0, 0, DateTimeKind.Unspecified), "john@example.com", "John", true, new DateTime(2023, 1, 1, 12, 0, 0, 0, DateTimeKind.Unspecified), "Doe", null, "hashedPassword1", 2 },
                    { 2, new DateTime(2023, 1, 1, 12, 0, 0, 0, DateTimeKind.Unspecified), "admin@example.com", "Admin", true, new DateTime(2023, 1, 2, 12, 0, 0, 0, DateTimeKind.Unspecified), "", null, "hashedPassword2", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "ManagerId", "CreatedAt", "Email", "IsActive", "ManagerName", "PasswordHash", "PhoneNumber", "UpdatedAt", "UserId", "Verification" },
                values: new object[] { 1, new DateTime(2023, 1, 1, 12, 0, 0, 0, DateTimeKind.Unspecified), "arjun@manager.com", true, "Arjun Kumar", "hashed123", "9876543210", new DateTime(2023, 1, 1, 12, 0, 0, 0, DateTimeKind.Unspecified), 1, "Unverified" });
            ...
            migrationBuilder.InsertData(
                table: "DineIn",
                columns: new[] { "TableId", "Capacity", "RestaurantId", "Status", "TableNo" },
                values: new object[,]
                {
                    { 1, 4, 1, "Available", "T1" },
                    { 2, 6, 1, "Reserved", "T2" }
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "[{\"ItemId\":1,\"Quantity\":2}]", new DateTime(2023, 1, 1, 12, 0, 0, 0, DateTimeKind.Unspecified), "DineIn", 2, 1, "InProgress", 536m, 1 },
                    { 2, "[{\"ItemId\":2,\"Quantity\":1}]", new DateTime(2023, 1, 2, 12, 0, 0, 0, DateTimeKind.Unspecified), "DineOut", 1, 1, "Pending", 157m, 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 1, 1, 12, 0, 0, 0, DateTimeKind.Unspecified), 1, 1, 1 });
