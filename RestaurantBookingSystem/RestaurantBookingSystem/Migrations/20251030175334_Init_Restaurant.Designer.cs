...
namespace RestaurantBookingSystem.Migrations
{
    ...
    [Migration("20251030175334_Init_Restaurant")]
    partial class Init_Restaurant
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestaurantBookingSystem.Model.Customers.Notifications", b =>
                {
            ...
            modelBuilder.Entity("RestaurantBookingSystem.Model.Customers.Cart", b =>
                {
                    b.HasOne("RestaurantBookingSystem.Model.Restaurant.MenuList", "MenuList")
                        .WithMany()
            ...
            modelBuilder.Entity("RestaurantBookingSystem.Model.Customers.Notifications", b =>
                {
                    b.HasOne("RestaurantBookingSystem.Model.Customers.Users", null)
                        .WithMany()
                        .HasForeignKey("UserId")
            ...
            modelBuilder.Entity("RestaurantBookingSystem.Model.Customers.Wishlist", b =>
                {
                    b.HasOne("RestaurantBookingSystem.Model.Restaurant.MenuList", "Item")
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("RestaurantBookingSystem.Model.Delivery.Delivery", b =>
                {
                    b.HasOne("RestaurantBookingSystem.Model.Delivery.DeliveryAddress", "DeliveryAddress")
                        .WithMany()
